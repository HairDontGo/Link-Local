...
function createInstructions() {
    ...
    text.innerHTML = '<div style="background:url("image/print/(5).png") no-repeat;"><span style="color:' + theme[0] + ';font-size:18px;">站长介绍：</span><table><tr> <td >姓名:&nbsp 刘秋麟</a>&nbsp &nbsp<br/><a>班级:&nbsp 17网络工程B2</a><br/><a>性别:<input type="radio" name="radiogroup1" value="男" checked="checked" />男 </a>   &nbsp;<br/><a>座右铭:&nbsp 陌上花开,</br>可缓缓归矣</a><br /></td><td >&nbsp;<img src="image/41.jpg" id="ZZ" class="ZZ" alt="年轻时的头像"  width="50px" height="70px"/></td></tr></table><a href="home.html"></tr></table><a href="home.html">点击返回首页</a></div>';
